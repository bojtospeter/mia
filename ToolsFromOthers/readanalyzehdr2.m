function [pre,dim,siz,lim,scale,offset,origin,descr,fileformat]=readanalyzehdr2(name);
% Reads the header of an analyze file
% 
%  [pre,dim,siz,lim[,scale[,offset[,origin[,descr[,fileformat]]]]]]=readanalyzehdr2(name)
%  [pre,dim,siz,lim,scale,offset,origin,descr,fileformat]=readanalyzehdr2(name)
%  [hdr]=readanalyzehdr2(name)
%  
